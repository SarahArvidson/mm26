    ...
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "24px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              >
                ...
                {generatedJoinCode && (
                  ...
                  >
                    ...
                    >
                      Partage ce code avec les élèves pour qu’ils rejoignent la
                      classe
                    </div>
                  </div>
                )}
                            ...
                            {resetPwStudentId === student.id ? (
                                ...
                                <div style={{ display: "flex", gap: "8px" }}>
                                  <button
                                    ...
                                    onClick={async () => {
                                      ...
                                      if (
                                        resetPwValue !== resetPwConfirmerValue
                                      ) {
                                        setStudentActionStatus((prev) => ({
                                          ...prev,
                                          [student.id]: {
                              ...
                              >
                                ...
                                <button
                                  type="button"
                                  onClick={() =>
                                    setShowDeleteConfirmer(student.id)
                                  }
                                  disabled={
                          ...
                          {studentActionStatus[student.id] && (
                            <div
                              style={{
                                ...
                                borderRadius: "4px",
                                backgroundColor:
                                  studentActionStatus[student.id].type ===
                                  "success"
                                    ? "#DCFCE7"
                                    : "#FEE2E2",
                                color:
        ...
        {renderPanel(
          "voting",
          "Votes en direct",
          selectedClassId && activeSeason && matchups.length > 0 && (
            <>
              {/* Live Voting */}
              {matchups.length > 0 && (
                <div
                  ...
                  >
                    {matchups
                      ...
                      .map((matchup) => {
                        ...
                        >((acc, v) => {
                          acc[v.picked_song_id] =
                            (acc[v.picked_song_id] || 0) + 1;
                          return acc;
                        }, {});
                        const participation =
                          classStudents.length > 0
                      ...
                      {activeSeason && matchups.length > 0 && (
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              Tous les tableaux de toutes les classes combinés
                            </h3>
                            <div
                              style={{
                                display: "grid",
                ...
                style={{
                  ...
                  cursor:
                    feedbackMessage.trim() && !feedbackSubmitting
                      ...
                      : "not-allowed",
                  opacity:
                    feedbackMessage.trim() && !feedbackSubmitting ? 1 : 0.6,
                }}
              >
